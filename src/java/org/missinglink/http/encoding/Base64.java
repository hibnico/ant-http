 ...
 */
package org.missinglink.http.encoding;
...
public class Base64 {
   ...
   * In earlier versions, it just returned a null value, but in retrospect
   ...
   *           if the decoded object is of a class that cannot be found by the
   *           JVM
   * @since 1.5
   */
